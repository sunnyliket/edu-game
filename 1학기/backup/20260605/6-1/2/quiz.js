...
// 과학 퀴즈 (산과 염기: 15문제, 물체의 운동: 15문제, 식물의 구조와 기능: 15문제, 지구의 운동: 15문제)
const scienceQuizzes = {
    1: [ // 1단계: 산과 염기
        {
            ...
            type: "CHOICE",
            options: [
                "산성용액, 염기성 용액들을 분류할 수 있는 물질",
                "물의 온도를 측정하여 따뜻함을 표시해 주는 액체",
                "물체의 무게를 재어 수치로 나타내는 지시기",
                "식물이 자라는 속도를 빠르게 돕는 특수 비료"
            ],
            answer: 0,
            explanation: "지시약은 어떤 용액을 만났을 때 색깔이 변하여 그 용액이 산성인지 염기성인지 구별(분류)할 수 있게 해주는 물질입니다."
        },
        {
            id: 102,
            question: "산성용액의 성질은 무엇일까요?",
            type: "CHOICE",
            options: [
                "단백질을 녹여 손에 닿으면 매우 미끈거린다.",
                "쓴맛이 나고 유리 세정제처럼 기름때를 잘 지운다.",
                "신맛이 나고 금속이나 달걀 껍데기를 녹이는 성질이 있다.",
                "아무 맛도 나지 않으며 조개껍데기와 전혀 반응하지 않는다."
            ],
            answer: 2,
            explanation: "산성 용액은 대개 신맛이 나며, 철이나 아연 같은 금속 및 탄산칼슘이 주성분인 달걀 껍데기, 조개껍데기를 녹입니다."
        },
        {
            id: 103,
            question: "염기성 용액의 성질은 무엇일까요?",
            type: "CHOICE",
            options: [
                "쓴맛이 나고 손에 닿으면 단백질을 녹여 미끈거린다.",
                "신맛이 나고 쇠로 된 못을 순식간에 녹여 버린다.",
                "설탕물처럼 달콤하며 끈적끈적하게 달라붙는다.",
                "붉은색 리트머스 종이를 아무 변화 없이 붉은색으로 둔다."
            ],
            answer: 0,
            explanation: "염기성 용액은 쓴맛이 나고, 단백질을 녹이는 성질이 있어 손가락으로 만지면 미끈미끈하게 느껴집니다."
        },
        {
            id: 104,
            question: "지시약들은 어떤 것이 있을까요?",
            type: "CHOICE",
            options: [
                "리트머스 종이, 페놀프탈레인 용액, 자주색 양배추 지시약, 메틸오렌지 등",
                "식초, 염산, 레몬즙, 탄산음료 등",
                "비눗물, 소독 알코올, 빨랫비누 물, 베이킹소다 등",
                "굴렁쇠, 에어백, 안전벨트, 신호등 등"
            ],
            answer: 0,
            explanation: "용액의 액성을 판별할 때 쓰이는 대표적인 지시약에는 리트머스 종이, 페놀프탈레인 용액, 자주색 양배추 지시약, 메틸오렌지 용액 등이 있습니다."
        },
        {
            id: 105,
        ...
        {
            id: 107,
            question: "페놀프탈레인 용액을 염기성 용액에 넣었을 때 색깔은 어떻게 변하나요?",
            type: "CHOICE",
            options: [
                "붉은색으로 변한다.",
                "푸른색으로 변한다.",
        ...
        {
            id: 110,
            question: "탄산수와 빨랫비누 물에 각각 페놀프탈레인 용액을 넣었을 때의 차이점은 무엇인가요?",
            type: "CHOICE",
            options: [
        ...
        {
            id: 114,
            question: "우리 일상생활에서 염기성 용액을 사용하는 예시들로 가장 알맞은 것은 무엇인가요?",
            type: "CHOICE",
            options: [
                "표백제, 유리 세정제, 하수구 세척제 등",
                "식초, 레몬즙, 사과 주스 등",
                "탄산수, 오렌지 주스, 토마토 주스 등",
                "염산, 아스피린 용액, 위산 등"
            ],
            answer: 0,
            explanation: "유리 세정제, 표백제, 비누 등은 단백질이나 찌든 때를 녹여 지우기 위해 염기성 용액을 사용합니다."
        },
        {
            id: 115,
            question: "산성 용액은 푸른색 리트머스 종이를 붉은색으로 변화시킨다.",
            type: "OX",
            answer: true,
    ...
    2: [ // 2단계: 물체의 운동
        {
            id: 201,
            question: "도로를 달리는 자동차는 시간이 지남에 따라 위치가 왜 변할까요?",
            type: "CHOICE",
            options: [
                "시간이 지남에 따라 물체의 위치가 변할 때 물체가 운동을 하기 때문입니다.",
                "자동차가 연료를 연소시켜 주변 온도를 상승시켰기 때문입니다.",
                "도로의 마찰력이 자동차를 밀어 올려서 공중에 띄웠기 때문입니다.",
                "자동차가 지구와 달 사이의 인력 중심점에 도달했기 때문입니다."
            ],
            answer: 0,
            explanation: "시간이 흐름에 따라 물체의 위치가 변하는 것을 과학적으로 '운동'이라고 부릅니다. 자동차의 위치가 변하는 것은 자동차가 운동하기 때문입니다."
        },
        {
            id: 202,
        ...
        {
            id: 215,
            question: "단위시간 동안 이동한 거리를 무엇이라고 부를까요?",
            type: "CHOICE",
            options: [
                "속력",
                "질량",
            ...
            answer: 0,
            explanation: "단위시간 동안 이동한 거리를 속력이라고 합니다."
        }
    ],
    3: [ // 3단계: 식물의 구조와 기능
        {
            id: 301,
            question: "세포벽이 있어 몸을 지지하고 광합성을 할 수 있는 생물은 무엇인가요?",
            type: "CHOICE",
            options: ["사람", "식물", "동물", "물체"],
            answer: 1,
            explanation: "세포벽과 엽록체가 있어 광합성을 하며 독립 영양 생활을 하는 생물은 식물입니다."
        },
        {
            id: 302,
        ...
        {
            id: 315,
            question: "수술에서 만들어진 꽃가루가 암술로 옮겨지는 것을 '꽃가루받이'라고 한다.",
            type: "OX",
            answer: true,
    ...
    4: [ // 4단계: 지구의 운동
        ...
        },
        {
            ...
            answer: 0,
            explanation: "지구의 자전은 지구가 자전축을 중심으로 하루에 한 바퀴씩 서쪽에서 동쪽으로 도는 운동입니다."
        },
        {
            id: 404,
        ...
        },
        {
            ...
            answer: 0,
            explanation: "지구의 공전은 지구가 태양 주위를 약 1년에 한 바퀴 서쪽에서 동쪽으로 도는 운동입니다."
        },
        {
            id: 406,
        ...
        {
            id: 409,
            question: "계절에 따라 남쪽 하늘에서 보이는 대표적인 별자리가 달라지는 가장 주된 원인은 무엇인가요?",
            type: "CHOICE",
            options: [
                "지구의 공전 때문에 지구의 위치가 바뀌어서",
                "달의 모양이 매일 바뀌기 때문에",
                "지구 자전 속도가 계절마다 급격히 변해서",
                "별들이 태양 주위를 직접 공전하고 있어서"
            ],
            answer: 0,
            explanation: "지구가 태양 주위를 공전하면서 지구의 위치가 달라져, 한밤중에 바라보는 우주의 방향에 있는 별자리가 달라집니다."
        },
        {
            id: 410,
            question: "봄, 여름, 가을, 겨울의 사계절이 나타나는 주된 요인 2가지는 무엇인가요?",
            type: "CHOICE",
            options: [
                "지구 자전축이 기울어진 채로 태양 주위를 공전하기 때문",
                "태양의 크기가 매달 달라지고 지구 자전 방향이 바뀌기 때문",
                "달이 태양을 가리는 일식 현상이 자주 발생하기 때문",
                "지구가 공전 궤도를 이탈하여 우주 밖으로 멀어지기 때문"
            ],
            answer: 0,
            explanation: "지구는 자전축이 23.5도 기울어진 채 태양 주위를 공전하므로, 계절에 따라 태양의 남중 고도와 낮의 길이가 달라져 계절의 변화가 생깁니다."
        },
        {
            id: 411,
            question: "우리나라가 위치한 북반구에서 낮의 길이가 가장 길고 태양 고도가 가장 높은 날의 절기는 무엇인가요?",
            type: "CHOICE",
            options: [
                "하지 (夏至)",
                "동지 (冬至)",
            ...
            answer: 0,
            explanation: "하지는 태양이 가장 높이 뜨고 낮이 가장 긴 날이며, 반대로 동지는 낮이 가장 짧고 밤이 가장 긴 날입니다."
        },
        {
            id: 412,
            question: "지구의 자전 방향은 동쪽에서 서쪽이다.",
            type: "OX",
            answer: false,
            explanation: "지구는 서쪽에서 동쪽으로 자전합니다. 이로 인해 하늘의 천체들이 동쪽에서 서쪽으로 움직이는 것처럼 보입니다."
        },
        {
            id: 413,
            question: "북쪽 하늘의 별들이 북극성을 중심으로 하루에 한 바퀴씩 회전하는 것처럼 보이는 현상은 지구의 무엇 때문인가요?",
            type: "CHOICE",
            options: [
                "지구의 자전",
                "지구의 공전",
            ...
            answer: 0,
            explanation: "지구 자전축의 연장선에 있는 북극성을 중심으로 다른 별들이 하루에 한 바퀴 회전하는 것처럼 보이는 것은 지구의 자전 때문입니다."
        },
        {
            id: 414,
            question: "지구가 태양 주위를 공전할 때 걸리는 시간은 정확히 며칠에 가깝나요?",
            type: "CHOICE",
            options: [
                "365일 (1년)",
                "30일 (1달)",
            ...
            answer: 0,
            explanation: "지구는 약 365일(1년) 동안 태양 주위를 한 바퀴 공전합니다."
        },
        {
            id: 415,
            question: "지구가 자전축을 중심으로 한 바퀴 도는 데 걸리는 시간은 24시간이다.",
            type: "OX",
            answer: true,
            explanation: "지구는 약 24시간(하루)에 한 바퀴 자전하여 낮과 밤이 생깁니다."
        }
    ]
};
