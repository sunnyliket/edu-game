...
const spaceLevels = {
  ...
  hard: {
    walls: [
      { x:200, y:0,   w:28, h:330 },
      { x:200, y:0,   w:150, h:30 }, // ceiling L
      { x:380, y:120, w:28, h:340 },
      { x:500, y:0,   w:28, h:330 },
      { x:500, y:230, w:95,  h:28 }, // mid floor
      { x:620, y:140, w:28, h:320 },
      { x:760, y:0,   w:28, h:300 },
      { x:760, y:390, w:120, h:28 }, // bottom shelf
      { x:910, y:130, w:28, h:330 },
      { x:1040,y:170, w:28, h:290 },
    ],
    platforms: [
      { x:1200, y:360, w:55,  h:18, s:'space' },
      { x:1290, y:280, w:50,  h:18, s:'space' },
      { x:1380, y:200, w:50,  h:18, s:'space' },
      { x:1470, y:290, w:50,  h:18, s:'space' },
      { x:1560, y:370, w:55,  h:18, s:'space' },
      { x:1650, y:280, w:50,  h:18, s:'space' },
      { x:1740, y:190, w:50,  h:18, s:'space' },
      { x:1830, y:280, w:50,  h:18, s:'space' },
      { x:1920, y:370, w:55,  h:18, s:'space' },
      { x:2010, y:280, w:50,  h:18, s:'space' },
      { x:2100, y:190, w:50,  h:18, s:'space' },
...
function resetGame() {
  ...
  gs.player = {
    ...
    w:36, h:36, grounded:false, facingRight:true,
    animTime:0, spinAngle:0, flying:false,
    inhaling: false, puffed: false, ability: null, spinAttackTime: 0
  };
...
function absorbMonster(monster) {
  ...
  p.inhaling = false;
  p.puffed = false;
  p.ability = monster.type;
  playSound('correct');
  spawnParticles(monster.x + monster.w / 2, monster.y + monster.h / 2, 28);
  addFloatingText(p.x + p.w / 2, p.y - 20, `능력 카피: ${abilityLabel(monster.type)}!`, '#38bdf8');
}
