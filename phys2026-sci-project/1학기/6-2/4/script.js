(() => {
  ...
  const stageQuestions = {
    1: [
      ...
      {
        category: "산과 염기",
        question: "실험실에서 용액의 냄새를 맡는 올바른 방법은 무엇입니까?",
        answer: "2. 손으로 바람을 일으켜 살짝 맡기",
        choices: [
          "1. 용액의 냄새는 맡지 않는다",
          "2. 손으로 바람을 일으켜 살짝 맡기",
          "3. 빨대로 용액을 찍어 코 가까이 가져간다",
          "4. 코를 병 입구에 대고 깊게 들이마신다"
        ],
        study: "실험실에서는 용액을 직접 코에 대지 않고, 손으로 바람을 일으켜 냄새를 아주 조금만 맡아야 합니다."
      },
      {
        category: "산과 염기",
        question: "실험실에서 용액이 피부에 묻었을 때 올바른 대처 방법은 무엇입니까?",
        answer: "3. 흐르는 물에 충분히 씻어냅니다",
        choices: [
          "1. 강한 염기성 용액을 발라 중화시킵니다",
          "2. 공기 중에 말려 용액을 증발시킵니다",
          "3. 흐르는 물에 충분히 씻어냅니다",
          "4. 헝겊으로 꾹꾹 눌러서 닦아냅니다"
        ],
        study: "용액이 피부에 묻으면 바로 선생님께 알리고 흐르는 물에 충분히 씻어야 합니다."
      },
      {
        category: "산과 염기",
        question: "자주색 양배추 지시약을 사용했을 때 노란색으로 변하는 용액은 어떤 상태입니까?",
        answer: "1. 강한 염기성",
        choices: ["1. 강한 염기성", "2. 강한 산성", "3. 약한 산성", "4. 완전한 중성"],
        study: "자주색 양배추 지시약은 강한 염기성에서 노란색 계열로 변합니다."
      },
      {
        category: "산과 염기",
        question: "속이 쓰릴 때 먹는 제산제는 어떤 원리를 이용한 것입니까?",
        answer: "2. 염기성으로 위산을 중화시킵니다",
        choices: [
          "1. 위산의 온도를 낮추어 줍니다",
          "2. 염기성으로 위산을 중화시킵니다",
          "3. 산성으로 위장을 코팅합니다",
        ...
        study: "제산제는 염기성 물질로 산성인 위산을 중화시키는 원리를 이용합니다."
      },
      {
        category: "산과 염기",
        question: "다음 중 중성 용액이라고 볼 수 있는 것은 무엇입니까?",
        answer: "4. 증류수",
        choices: ["1. 변기 세정제", "2. 유리 세정제", "3. 사과즙", "4. 증류수"],
        study: "증류수는 산성이나 염기성으로 치우치지 않은 중성 용액으로 볼 수 있습니다."
      }
    ],
    2: [
      {
      ...
      {
        category: "물체의 운동",
        question: "어떤 물체가 처음 2초 동안은 10 m를 이동했고, 그다음 3초 동안은 25 m를 이동했습니다. 이 물체의 전체 구간에서의 평균 속력은 몇 m/s인가요?",
        answer: "7 m/s",
        choices: ["5 m/s", "7 m/s", "10 m/s", "35 m/s"],
        study: "전체 이동 거리는 35 m, 전체 시간은 5초이므로 평균 속력은 35 나누기 5, 즉 7 m/s입니다."
      },
      {
        category: "물체의 운동",
        question: "일정한 속력 4 m/s로 걸어가는 사람이 2 km 떨어진 대형마트까지 걸어가려고 할 때 걸리는 시간은 몇 초인가요?",
        answer: "500초",
        choices: ["125초", "250초", "500초", "8000초"],
        study: "2 km는 2000 m이고, 시간은 거리 나누기 속력이므로 2000 나누기 4는 500초입니다."
      },
      {
        category: "물체의 운동",
        question: "기차가 90 km/시의 일정한 속력으로 철교를 건너고 있습니다. 이 기차가 15분 동안 달린다면 이동한 거리는 몇 km입니까?",
        answer: "2. 22.5 km",
        choices: ["1. 15 km", "2. 22.5 km", "3. 45 km", "4. 90 km"],
        study: "15분은 0.25시간이고, 90 km/시에 0.25시간을 곱하면 22.5 km입니다."
      },
      {
        category: "물체의 운동",
        question: "같은 거리를 이동할 때 걸린 시간이 2배가 되면, 그 물체의 속력은 2배가 된다. OX",
        answer: "X",
        choices: ["O", "X"],
        study: "같은 거리를 더 오래 걸려 이동하면 속력은 커지는 것이 아니라 작아집니다."
      },
      {
        category: "물체의 운동",
        question: "직선 도로에서 0초부터 5초까지는 2 m/s로 달리고, 5초부터 10초까지는 8 m/s로 달린 물체의 10초 동안의 평균 속력은 5 m/s이다. OX",
        answer: "O",
        choices: ["O", "X"],
        study: "5초 동안 10 m, 다음 5초 동안 40 m를 이동해 총 50 m를 10초 동안 움직였으므로 평균 속력은 5 m/s입니다."
      }
    ],
    3: [
      {
      ...
      },
      {
        ...
        study: "꽃은 보통 암술, 수술, 꽃잎, 꽃받침으로 이루어져 있습니다."
      },
      {
        category: "식물의 구조와 기능",
        question: "식물은 낮에는 광합성만 하고, 밤에는 호흡만 한다. OX",
        answer: "X",
        choices: ["O", "X"],
        study: "식물은 낮에도 밤에도 호흡을 하며, 빛이 있을 때 광합성도 함께 합니다."
      },
      {
        category: "식물의 구조와 기능",
        question: "꽃가루받이가 끝나면 씨방이 자라 무엇이 되고, 밑씨는 무엇이 되나요?",
        answer: "열매, 씨",
        choices: ["열매, 씨", "씨, 열매", "꽃잎, 꽃받침", "기공, 뿌리털"],
        study: "꽃가루받이 뒤에는 씨방이 자라 열매가 되고, 밑씨는 씨가 됩니다."
      },
      {
        category: "식물의 구조와 기능",
        question: "식물의 잎 뒷면에 있는 기공을 현미경으로 관찰하려고 합니다. 다음 중 기공과 증산 작용에 대한 설명으로 옳지 않은 것은 무엇인가요?",
        answer: "기공은 주로 잎의 앞면에 밤에만 열려 있다",
        choices: [
          "기공은 주로 잎의 앞면에 밤에만 열려 있다",
          "기공을 통해 수증기가 밖으로 빠져나갈 수 있다",
          "증산 작용은 물이 수증기가 되어 빠져나가는 현상이다",
          "기공은 잎에서 기체가 드나드는 작은 구멍이다"
        ],
        study: "기공은 주로 잎의 뒷면에 많고, 증산 작용과 기체 출입에 관여합니다."
      },
      {
        category: "식물의 구조와 기능",
        question: "식물은 낮에는 광합성 활동으로 인해 산소만 내보내고 이산화 탄소는 전혀 내보내지 않는다. OX",
        answer: "X",
        choices: ["O", "X"],
        study: "식물은 낮에 광합성으로 산소를 많이 내보내지만, 호흡도 계속 하므로 이산화 탄소를 전혀 내보내지 않는 것은 아닙니다."
      }
    ],
    4: [
      {
        ...
        study: "지구가 서쪽에서 동쪽으로 자전하기 때문에 하늘의 천체들은 동쪽에서 서쪽으로 이동하는 것처럼 보입니다."
      },
      {
        category: "지구의 운동",
        ...
        study: "지구가 자전축을 기준으로 매일 한 바퀴씩 도는 운동을 지구의 자전이라고 합니다."
      },
      {
        category: "지구의 운동",
        ...
        study: "지구가 태양 주위를 일 년에 한 바퀴씩 도는 운동을 공전이라고 합니다."
      },
      {
        category: "지구의 운동",
        ...
        study: "지구의 공전 방향은 자전과 마찬가지로 서쪽에서 동쪽 방향입니다."
      },
      {
        category: "지구의 운동",
        ...
        answer: "밤",
        choices: ["밤", "낮", "계절", "기온"],
        study: "지구는 둥글기 때문에 태양 빛이 닿지 않는 반대쪽 면은 밤이 됩니다."
      },
      {
        category: "지구의 운동",
        ...
        study: "태양 빛이 직접 비치는 지구의 밝은 쪽 지역은 낮이 됩니다."
      },
      {
        category: "지구의 운동",
        question: "지구의 자전 방향은 어느 방향에서 어느 방향인가요?",
        answer: "서쪽에서 동쪽으로 (시계 반대 방향)",
        choices: ["서쪽에서 동쪽으로 (시계 반대 방향)", "동쪽에서 서쪽으로", "남쪽에서 북쪽으로", "북쪽에서 남쪽으로"],
        study: "지구는 북극 상공에서 보면 시계 반대 방향, 즉 서쪽에서 동쪽으로 자전합니다."
      },
      {
        category: "지구의 운동",
        question: "달이 지구를 중심으로 한 달에 한 바퀴씩 회전하는 운동을 무엇이라 하나요?",
        answer: "달의 공전",
        choices: ["달의 공전", "달의 자전", "지구의 자전", "지구의 공전"],
        study: "달이 지구를 중심으로 한 달에 한 바퀴씩 도는 운동을 달의 공전이라고 합니다."
      },
      {
        category: "지구의 운동",
        question: "지구의 공전 주기는 약 얼마인가요?",
        answer: "약 365일",
        choices: ["약 12시간", "약 365일", "약 30일", "약 24시간"],
        study: "지구는 태양 주위를 약 365일(1년)에 한 바퀴씩 공전합니다."
      },
      {
        category: "지구의 운동",
        question: "태양이 동쪽에서 서쪽으로 뜬다. OX",
        answer: "O",
        choices: ["O", "X"],
        study: "지구의 자전으로 인해 태양은 동쪽에서 떠서 서쪽으로 지는 것처럼 보입니다."
      },
      {
        category: "지구의 운동",
        question: "밤하늘의 별들이 북극성을 중심으로 원을 그리며 도는 것처럼 보이는 이유는 무엇인가요?",
        answer: "지구가 자전축을 중심으로 자전하기 때문이다",
        choices: [
          "지구가 자전축을 중심으로 자전하기 때문이다",
          "북극성이 지구 주위를 빠르게 돌기 때문이다",
          "태양이 밤마다 별을 밀어내기 때문이다",
          "달이 별들을 끌어당기기 때문이다"
        ],
        study: "지구가 자전하기 때문에 밤하늘의 별들이 북극성을 중심으로 원을 그리며 움직이는 것처럼 보입니다."
      }
    ]
  };
  ...
  function setupGame() {
    state.stage = 1;
    state.heartCounts = createHeartCounts();
    state.heartLossIndex = 0;
    state.truthCount = 0;
  ...
  function renderCrew(status = "solving") {
    ...
    students.forEach((student) => {
      ...
      const studentHearts = state.heartCounts[student] ?? 3;
      const hearts = document.createElement("span");
      hearts.className = "crew-hearts";
      hearts.setAttribute("aria-label", `${student} 남은 하트 ${studentHearts}개`);

      for (let index = 0; index < 3; index += 1) {
        const heart = document.createElement("span");
        heart.className = "crew-heart";
        if (index >= studentHearts) {
  ...
  function arrangeChoices(question) {
    ...
    const answer = choices.splice(answerIndex, 1)[0];
    const slotCount = Math.min(4, question.choices.length);
    const targetIndex = nextAnswerSlot(slotCount);
    choices.splice(targetIndex, 0, answer);
    return choices;
  }

  function nextAnswerSlot(slotCount) {
    const key = String(slotCount);
    if (!state.answerSlotBags[key] || state.answerSlotBags[key].length === 0) {
      state.answerSlotBags[key] = shuffle([...Array(slotCount).keys()]);
    }
    return state.answerSlotBags[key].shift();
  }
  ...
  function renderQuestion() {
    ...
    state.currentChoices = arrangeChoices(question);
  ...
  function handleChoice(event) {
    ...
    const question = currentQuestion();
    const selectedChoice = button.dataset.choice || button.textContent;
    ...
    const lostHeart = loseNextStudentHeart();
    elements.feedback.className = "feedback is-danger";
    elements.feedback.textContent = `오답이다. ${lostHeart.student}의 하트가 하나 사라졌다. 남은 하트는 ${lostHeart.hearts}개, 네 명 모두 진실의 방으로 향한다.`;
    window.setTimeout(enterTruthRoom, 700);
  }

  function loseNextStudentHeart() {
    for (let attempt = 0; attempt < students.length; attempt += 1) {
      const student = students[state.heartLossIndex % students.length];
      state.heartLossIndex += 1;
      const currentHearts = state.heartCounts[student] ?? 0;

      if (currentHearts > 0) {
        state.heartCounts[student] = currentHearts - 1;
        renderCrew("studying");
        return { student, hearts: state.heartCounts[student] };
      }
    }

    renderCrew("studying");
    return { student: "모두", hearts: 0 };
  }
  ...
  function enterTruthRoom() {
    ...
    elements.truthMessage.textContent = "문제를 틀리면 네 명 모두 진실의 방에서 정답 해설을 확인한다. 스페이스키를 누르면 바로 같은 문제에 다시 도전한다.";
    elements.truthAnswer.textContent = question.answer;
    elements.studyNote.textContent = question.study;
    elements.studySeconds.textContent = "Space";
  ...
  function leaveTruthRoom() {
    ...
    renderCrew("solving");
    // 틀린 문제를 대기열 맨 뒤로 보내 즉시 반복 출제를 방지한다
    if (state.questions.length > 1 && state.roundIndex < state.questions.length) {
      state.questions.push(state.questions.splice(state.roundIndex, 1)[0]);
    }
    renderQuestion();
  }
  ...
  function handleKeyboardAdvance(event) {
    ...
    if (state.inTruthRoom && !elements.truthModal.hidden) {
      event.preventDefault();
      leaveTruthRoom();
      return;
    }

    if (!elements.stageClearModal.hidden) {
      event.preventDefault();
      nextStage();
      return;
    }
  ...
  // ── 드래그 화면 이동(Pan) ────────────────────────────────────────────────
  const panState = { active: false, startX: 0, startY: 0, x: 0, y: 0 };
  const PAN_MAX_X = 260;
  const PAN_MAX_Y = 170;

  function applyPanVars() {
    ...
    document.documentElement.style.setProperty("--pan-x", `${panState.x.toFixed(1)}px`);
    document.documentElement.style.setProperty("--pan-y", `${panState.y.toFixed(1)}px`);
  }

  function isPanBlockedTarget(el) {
    if (!el || typeof el.closest !== "function") return false;
    return Boolean(
      el.closest(".hud") ||
      el.closest(".crew-panel") ||
      el.closest(".teacher-sheet") ||
      el.closest(".key-rack") ||
      el.closest(".key-spot") ||
      el.closest("button")
    );
  ...
  const labStageElement = document.querySelector(".lab-stage");

  if (labStageElement) {
    labStageElement.addEventListener("pointerdown", (evt) => {
      if (BACKGROUND_LOCKED) return;
      if (isPanBlockedTarget(evt.target)) return;
      panState.active = true;
      panState.startX = evt.clientX - panState.x;
      panState.startY = evt.clientY - panState.y;
      labStageElement.classList.add("is-panning");
      labStageElement.setPointerCapture(evt.pointerId);
    });
  }
  ...
  window.addEventListener("pointermove", (evt) => {
    ...
    const nx = evt.clientX - panState.startX;
    const ny = evt.clientY - panState.startY;
    panState.x = Math.max(-PAN_MAX_X, Math.min(PAN_MAX_X, nx));
    panState.y = Math.max(-PAN_MAX_Y, Math.min(PAN_MAX_Y, ny));
    applyPanVars();
  });
  ...
  window.addEventListener("pointerup", () => {
    ...
    if (labStageElement) labStageElement.classList.remove("is-panning");
  });
